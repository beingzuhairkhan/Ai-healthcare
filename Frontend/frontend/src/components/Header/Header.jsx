        ...
        <div className="flex items-center justify-between">
          ...
          <div>
            <img
              src={Logo}
              alt=""
              className="h-[80px] w-[80px] bg-white rounded-full"
            ></img>
          </div>

          {/* menu */}
          <div
            className="navigation flex justify-between gap-5"
            ref={menuRef}
            onClick={toggleMenu}
          >
                ...
                >
                  <figure className="w-[35px] h-[35px] rounded-full cursor-pointer ">
                    <img
                      src={user?.photo}
                      alt=""
                      className="rounded-full w-full border border-solid border-black ml-[45px]"
                    />
                  </figure>
