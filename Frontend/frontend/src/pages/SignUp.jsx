          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form action="" onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className="text-headingColor font-bold text-[16px] leading-7">
                  ...
                  <select name='role' value={formdata.role} onChange={handleInputSumbit} className="text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
                    ...
                    <option value="patient">Patient</option> {/* corrected value */}
              ...
              <div className="mb-5 flex items-center gap-3">
                {setSeletecdFile && <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
