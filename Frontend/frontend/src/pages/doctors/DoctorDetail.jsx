            ...
            <div className="flex items-center gap-5 mt-[50px]  justify-center px-[170px] ">
              ...
              <div >
                ...
                <div className="flex items-center gap-[6px]">
                  ...
                  <span className=" text-[14px] leading-5 lg:text-[16px] lg:leading-7 font-semibold text-headingColor">({totalRating})</span> 
                </div>
                  <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px] text-justify">{bio}</p>
              </div>

            </div>
            <div className="mt-[50px]  border-b border-solid border-[#0066ff34] flex justify-start px-[170px]" >
